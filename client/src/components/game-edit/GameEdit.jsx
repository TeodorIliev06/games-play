...
export default function GameEdit(){
    ...
    // one way and pass to from initialFromValues or pre set how will game look (it properties so it doesnt't give uncontroleld form errro 2:39:00 workshop1 advanced techniques)
   // const initialFormValues = useMemo(()=>Object.assign({},initialValues,game),[game])
    const {
        changeHandler,
        submitHandler,
        values
    } = useForm(game, async (values) => { // might want to { ...initialValues, ...game }
